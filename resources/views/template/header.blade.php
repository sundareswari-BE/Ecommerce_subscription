...
<body>
    ...
    <div class="sidebar px-4" id="sidebar">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link text-light" href="{{ route('userdashboard') }}"><i
                        class="fa-solid fa-gauge-simple-high"></i> Dashboard</a>
                <hr class="m-0 text-light">
            </li>
            <li class="nav-item">
                <a class="nav-link text-light" href="{{ route('categoryPage') }}"><i
                        class="fa-solid fa-layer-group"></i> Category</a>
                <hr class="m-0 text-light">
            </li>
            {{-- <li class="nav-item">
        ...
        <hr class="m-0 text-light">
            ...
            <li class="nav-item">
                <a class="nav-link text-light" href="{{ route('logout') }}"><i
        ...
        <div class="subscription-box">
            <a class="nav-link text-light mt-3 upgrade_button  subscription-link"
                href=" {{ route('subcribtionformshowdata') }}">
          ...
          <nav class="navbar navbar-expand-sm navbar-light bg-dark dashboard-nav p-3">
              <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarNav">
                      <!-- Add this HTML snippet within the div.row.mb-4 -->
                      <div class="col-12">
                        <form class="d-flex" action="{{ route('search') }}" method="GET">
                          <input class="form-control me-2 search" type="search" name="search" placeholder="Search products, categories" aria-label="Search">
